...
This analysis looks at all alumni and current parents with a primary address in `r regional_name`. The time period included is from `r format(as.Date(as.character(from), "%Y%m%d"),  "%B %d, %Y")` to `r format(as.Date(as.character(to), "%Y%m%d"),  "%B %d, %Y")`.
