...
There are currently `r comma(n_distinct(region_prospects$entity_id))` alumni and current parents in `r region_name`, comprising `r comma(n_distinct(region_prospects$hh_id))` households.
