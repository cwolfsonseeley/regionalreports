...
school <- function(school_code) {
  ...
  getcdw::get_cdw(school_query(school_code = school))
}
...
imp_cap <- function(school_code) {
  ...
  getcdw::get_cdw(imp_cap_query(school_code = school))
}
...
mgs <- function(school_code) {
  ...
  getcdw::get_cdw(mgs_query(school_code = school))
}
...
events <- function(school_code, from, to) {
  ...
  getcdw::get_cdw(events_query(school_code = school, from = from, to = to))
}
...
visits <- function(school_code, from, to) {
  ...
  getcdw::get_cdw(visits_query(school_code = school, from = from, to = to))
}
...
gifts <- function(school_code, from, to) {
  ...
  getcdw::get_cdw(gifts_query(school_code = school, from = from, to = to))
}
...
proposals <- function(school_code, from, to) {
  ...
  getcdw::get_cdw(proposals_query(school_code = school, from = from, to = to))
}

## get the data
school_prospects <- school(school_code = school)
...
imp_cap <- imp_cap(school_code = school)
mgs <- mgs(school_code = school)
events <- events(school_code = school, from = from, to = to)
visits <- visits(school_code = school, from = from, to = to)
gifts <- gifts(school_code = school, from = from, to = to)
proposals <- proposals(school_code = school, from = from, to = to)
